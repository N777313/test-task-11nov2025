CREATE TYPE public.fuel_analytics_result_by_bekzat AS (
    total_consumption_liters numeric,
    total_refilled_liters numeric,
    refills_count integer,
    anomalous_drops_count integer,
    avg_consumption_lph numeric,
    start_fuel_level numeric,
    end_fuel_level numeric,
...
ALTER FUNCTION public.analyze_fuel_consumption_by_bekzat(int4, date, int4, date, int4) OWNER TO stu;
GRANT ALL ON FUNCTION public.analyze_fuel_consumption_by_bekzat(int4, date, int4, date, int4) TO stu;
