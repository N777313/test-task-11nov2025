...
SELECT * FROM fuel_used_by_shifts_r2_2(
    peqmt := 25,
...
--Main release 2.1
CREATE OR REPLACE FUNCTION public.fuel_used_by_shifts_r2_2(
    peqmt integer,
    pstartdate date,
    pstartshift integer,
    penddate date,
...
begin
   ...
   -- Финальное сообщение отладки
    ...
    ----------------------------------------------------------------
    -- 🧹 4. Очистка: удаление материализованного представления и индекса
    ----------------------------------------------------------------
